...
public class update_student extends javax.swing.JFrame {
    ...
    public boolean updatechecker() {
        ...
        try {
            String query = "SELECT * FROM tbl_student WHERE (email = '" + em.getText() + "')  AND student_id != '"+id.getText()+"'";
    ...
    private void initComponents() {
        ...
        jPanel2.add(CONFIRM, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 280, -1, -1));

        id.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jPanel2.add(id, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 90, 60, 30));

        jLabel4.setText("Student ID:");
        jPanel2.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 90, 60, 30));
    ...
    try (Connection conn = db.getConnection()) {
        ...
        String query = "UPDATE tbl_student SET fname=?, lname=?, email=?, contact=? WHERE student_id=?";
