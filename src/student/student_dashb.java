...
public class student_dashb extends javax.swing.JFrame {
    ...
    private void jPanel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel4MouseClicked
        ...
        if(rowIndex < 0){
           ...
           ResultSet rs = db.getData("SELECT * FROM tbl_student WHERE student_id ='"+tbl.getValueAt(rowIndex, 0 )+"'");
           if(rs.next()){
             update_student us = new update_student();
             us.id.setText(""+rs.getInt("student_id"));
    ...
    private void jPanel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel5MouseClicked
        ...
        if(rowindex < 0){
            ...
            if (confirm == JOptionPane.YES_OPTION) {
                ...
                dbc.updateData("DELETE FROM tbl_student WHERE student_id = '" + id + "'");
                displayUsers();
