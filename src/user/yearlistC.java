 ...
 * @author HP745 G3
 */
public class yearlistC extends javax.swing.JFrame {
    ...
    private void jPanel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel3MouseClicked
        grade_dashC1 ins_dashb = new grade_dashC1();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(yearlistC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
