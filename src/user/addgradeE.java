 ...
 * @author HP745 G3
 */
public class addgradeE extends javax.swing.JFrame {
    ...
    try {
        ...
        if (rowsInserted > 0) {
            ...
            grade_dashE1 gd = new grade_dashE1();
            gd.setVisible(true);
            this.dispose();
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(addgradeE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
