 ...
 * @author HP745 G3
 */
public class yearlistB extends javax.swing.JFrame {
    ...
    private void jPanel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel3MouseClicked
        grade_dashB1 ins_dashb = new grade_dashB1();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(yearlistB.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
