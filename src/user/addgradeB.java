 ...
 * @author HP745 G3
 */
public class addgradeB extends javax.swing.JFrame {
    ...
    try {
        ...
        if (rowsInserted > 0) {
            ...
            grade_dashB1 gd = new grade_dashB1();
            gd.setVisible(true);
            this.dispose();
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(addgradeB.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
