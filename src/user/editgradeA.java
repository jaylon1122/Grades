 ...
 * @author HP745 G3
 */
public class editgradeA extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        grade_dashA1 editgrade = new grade_dashA1();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(editgradeA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new editgradeA().setVisible(true);
            }
        });
    }
    ...
    public javax.swing.JTextField finalg;
    ...
    public javax.swing.JTextField prefinal;
