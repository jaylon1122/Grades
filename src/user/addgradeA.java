 ...
 * @author HP745 G3
 */
public class addgradeA extends javax.swing.JFrame {
    ...
    String courseIdText = (String) course.getSelectedItem(); 
    ...
    try {
        ...
        // Ensure grades are between 1.0 and 5.0 and not whole numbers
            if ((prelimGrade < 1.0 || prelimGrade > 5.0) ||
            (midtermGrade < 1.0 || midtermGrade > 5.0) ||
            (prefinalGrade < 1.0 || prefinalGrade > 5.0) ||
            (finalGrade < 1.0 || finalGrade > 5.0)) {
            JOptionPane.showMessageDialog(this, 
                "All grades must be between 1.0 and 5.0 inclusive!", 
                "Invalid Grade Input", 
        ...
        if (rowsInserted > 0) {
            ...
            grade_dashA1 gd = new grade_dashA1();
            gd.setVisible(true);
            this.dispose();
        } else {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        grade_dashA1 grade = new grade_dashA1();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(addgradeA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
