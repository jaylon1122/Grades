 ...
 * @author HP745 G3
 */
public class grade_dashB1 extends javax.swing.JFrame {
    ...
    public void displayUsers() {
        try {
            ...
            ResultSet rs = db.getData("SELECT program AS 'Program', course AS 'Subject Code', course_description AS 'Subject Description', section AS 'Sections', "
                    + "studentID AS 'Student ID' FROM tbl_enrollment WHERE section = 'B' AND year_level = '1st Year'");
     ...
     public void displayUsers2(){
        ...
        ResultSet rs = db.getData("SELECT e.studentID, g.id AS 'Grade ID', g.course, g.prelim, g.midterm, g.prefinal, g.final " +
                  "FROM tbl_enrollment e LEFT JOIN tbl_grade g ON e.studentID = g.student_id WHERE section = 'B' AND year_level = '1st Year'");
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 600, -1, -1));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 480, 590, 240));
        ...
        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 120, 590, 310));
    ...
    int rowIndex = enroll_list.getSelectedRow();
        if(rowIndex < 0){
           ...
           if(rs.next()){
             addgradeB grade_dashb = new addgradeB();
    ...
    int rowIndex = gradelist.getSelectedRow();
        if(rowIndex < 0){
           ...
           if(rs.next()){
             editgradeB grade_dash = new editgradeB();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(grade_dashB1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new grade_dashB1().setVisible(true);
            }
        });
    }
