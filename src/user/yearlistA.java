 ...
 * @author HP745 G3
 */
public class yearlistA extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(yearlistA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
