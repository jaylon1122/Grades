 ...
 * @author HP745 G3
 */
public class addgradeD extends javax.swing.JFrame {
    ...
    try {
        ...
        if (rowsInserted > 0) {
            ...
            grade_dashD1 gd = new grade_dashD1();
            gd.setVisible(true);
            this.dispose();
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(addgradeD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
