 ...
 * @author HP745 G3
 */
public class addgradeC extends javax.swing.JFrame {
    ...
    try {
        ...
        if (rowsInserted > 0) {
            ...
            grade_dashC1 gd = new grade_dashC1();
            gd.setVisible(true);
            this.dispose();
        } else {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        grade_dashC1 dash = new grade_dashC1();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(addgradeC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
