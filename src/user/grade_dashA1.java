 ...
 * @author HP745 G3
 */
public class grade_dashA1 extends javax.swing.JFrame {
    ...
    public void displayUsers() {
        try {
            ...
            ResultSet rs = db.getData("SELECT program AS 'Program', course AS 'Subject Code', course_description AS 'Subject Description', section AS 'Sections', "
                    + "studentID AS 'Student ID' FROM tbl_enrollment WHERE section = 'A' AND year_level = '1st Year'");
     ...
     public void displayUsers2(){
        ...
        ResultSet rs = db.getData("SELECT e.studentID, g.id AS 'Grade ID', g.course, g.prelim, g.midterm, g.prefinal, g.final " +
                  "FROM tbl_enrollment e LEFT JOIN tbl_grade g ON e.studentID = g.student_id WHERE section = 'A' AND year_level = '1st Year'");
    ...
    int rowIndex = enroll_list.getSelectedRow();
        if(rowIndex < 0){
           ...
           if(rs.next()){
             addgradeA grade_dashb = new addgradeA();
    ...
    int rowIndex = gradelist.getSelectedRow();
        if(rowIndex < 0){
           ...
           if(rs.next()){
             editgradeA grade_dash = new editgradeA();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(grade_dashA1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new grade_dashA1().setVisible(true);
            }
        });
    }
