...
public class update_admin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(status, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 240, 190, 40));

        type1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Admin", "User" }));
        jPanel1.add(type1, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 140, 190, 40));
        ...
        jPanel1.add(up, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 300, 90, 30));
        ...
        jPanel1.add(cn, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 300, 90, 30));
    ...
    try {
        if (fname.getText().isEmpty() || lastname.getText().isEmpty() || 
            email.getText().isEmpty() || ph.getText().isEmpty()) {
        ...
        connectDB db = new connectDB();
        String query = "UPDATE tbl_users SET fname=?, lname=?, email=?, phone_number=?, type=?, status = ? WHERE id=?";
        ...
        try (Connection conn = db.getConnection();
            ...
            pstmt.setString(6, (String) status.getSelectedItem()); 
