...
public class reg_admin extends javax.swing.JFrame {
    ...
    private void registerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerActionPerformed
        if(username.getText().isEmpty() || fname.getText().isEmpty() || lname.getText().isEmpty() || em.getText().isEmpty()  || cn.getText().isEmpty() || pass.getText().isEmpty()){ 
            ...
            try{
                ...
                if (db.insertData("INSERT INTO tbl_users(username, fname, lname, email, contact, type, pass, status) "
                    + "VALUES ('"+username.getText()+"', '"+fname.getText()+"', '"+lname.getText()+"', '"+em.getText()+"', '"+cn.getText()+"', '"+ut.getSelectedItem()+"', '"+password+"',  '"+us.getSelectedItem()+"')") == 1 ) {
