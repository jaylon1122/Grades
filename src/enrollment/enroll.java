...
public class enroll extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 40, -1, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            connectDB db = new connectDB();
             String checkQuery = "SELECT * FROM tbl_student WHERE student_id = ?";
            ...
            if (rowsInserted > 0) {
                ...
                enroll_table et = new enroll_table();
                et.setVisible(true);
                this.dispose();
            } else {
    ...
    private void jLabel10MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel10MouseClicked
        enroll_table student_dashb = new enroll_table();
